...
parser.add_argument("--rotation-max-eps", type=float, default=0.1, help="max rotation angle for MLP regularizer (0 = disabled)")
...
model_config_kwargs = dict(sequence_len=args.max_seq_len, vocab_size=vocab_size, n_layer=num_layers, n_head=num_heads, n_kv_head=num_kv_heads, n_embd=model_dim, window_pattern=args.window_pattern, rotation_max_eps=args.rotation_max_eps)
