...
parser.add_argument("--look-around-heads", type=int, default=0, help="number of heads with look-around attention (0=disabled, uses Flash Attention)")
...
model_config_kwargs = dict(sequence_len=args.max_seq_len, vocab_size=vocab_size, n_layer=num_layers, n_head=num_heads, n_kv_head=num_kv_heads, n_embd=model_dim, window_pattern=args.window_pattern, n_look_around_heads=args.look_around_heads)
